...
<div class="chat">
<a style="text-decoration:none;" href="#"><div id="sc"><center ><img style="float:left;" src="img/ruet.png" width="20px" height="20px"/><b>ChatBOT</b></center></div></a>
<div id="panel">
...
$(document).ready(function(){
    ...
    $("#sc").click(function(){
          ...
          if(i==1)
          {
              $('#div').html("<div class=\"ou\"> Bem vindo ao CHAT</div><br>");
